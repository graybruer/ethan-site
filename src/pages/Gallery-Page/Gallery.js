        ...
        <motion.div className="Gallery"
            ...
            <article className='GalleryContent'>
                ...
                <div className='project'>
                    <img src={project7} alt="Feature Project"></img>
                    <div className='projectTitleRight'>Kiss of Death</div>
                </div>
                <div className='project'>
                    <img src={project6} alt="Feature Project"></img>
                    <div className='projectTitleLeft'>Ginny and Georgia</div>
                </div>
                <div className='project'>
                ...
                <div className='project'>
                    ...
                    <div className='projectTitleLeft'>How To Die Alone</div>
                </div>
                <div className='project'>
                    <img src={project3} alt="Feature Project"></img>
                    <div className='projectTitleRight'>The Way Home</div>
                </div>
                <div className='project'>
